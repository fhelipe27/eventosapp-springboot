...
```mermaid
  ...
  Evento "1" --> "N" Convidado: possui
  Convidado "N" --> "1" Evento: está associado a

  EventoController --> EventoRepository: usa
  EventoController --> ConvidadoRepository: usa
  IndexController --> EventoController: usa
